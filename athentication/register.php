...
<head>
    ...
    <link rel="icon" type="image/png" sizes="16x16" href="../public/backen/assets/images/neptune.png" />
        ...
        <div class="app-auth-container">
            ...
            <div class="auth-credentials m-b-xxl">
                ...
                <input name="email" type="email" class="form-control m-b-md <?php if(isset($_SESSION['email_error'])) 
                 {echo 'is-invalid';}else{echo '';} ?>" id="signUpEmail" aria-describedby="signUpEmail" placeholder="example@neptune.com">
