        ...
        <div class="app-auth-container">
            ...
            <p class="auth-description">Please sign-in to your account and continue to the dashboard.<br>Don't have an account? <a href="register.php">Sign Up</a></p>
             ...
             <!-- register complete msg -->
              <?php if(isset( $_SESSION["register_name"]) && isset( $_SESSION["register_name"])){ ?>
            ...
            <!-- register complete msg -->
             ...
             <!-- register complete msg -->
              <?php if(isset( $_SESSION["signin_unsuccess"])){ ?>
            <div class="alert alert-custom" role="alert">
                <div class="custom-alert-icon icon-success" ><i class="material-icons-outlined">done</i></div>
                <div class="alert-content">
                    <span class="alert-title">
                        <?php echo $_SESSION["signin_unsuccess"] ?>
                        <span class="alert-text">
                            <?php echo $_SESSION["signin_unsuccess"]?>
                        </span>
                    </span>
            ...
            <?php  } unset( $_SESSION["signin_unsuccess"]);   ?>
            <!-- register complete msg -->
