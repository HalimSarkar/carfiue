...
header('location:../../athentication/signin.php');
}
            ...
            <div class="logo">
                ...
                <div class="sidebar-user-switcher user-activity-online">
                    <a href="#">
                        ...
                        <?php if( $users ['image']== 'PASSPORT.png'): ?>
                        <img src="../../public/uploads/default/<?= $users ['image']?>">
                        <?php else: ?>
                        <img src="../../public/uploads/profile/<?= $users ['image']?>">
                        <?php endif; ?>
            ...
            <div class="app-menu">
                <ul class="accordion-menu">
                    ...
                    <li class="<?= ($link == 'index.php') ? 'active-page': '' ?>">
                            <a href="../../index.php"><i class="material-icons-two-tone">visibility</i>web site</a>
                    </li>

                    <li class="<?= ($link == 'services.php') ? 'active-page': '' ?>">
                            <a href="../../backend/service/services.php"><i class="material-icons-two-tone">medical_services</i>service</a>
                    </li>
